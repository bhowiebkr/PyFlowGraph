...
### AC2: Breadcrumb navigation showing current group hierarchy
**Given** user is viewing inside an expanded group  
**When** group is displayed  
**Then** breadcrumb navigation shows current location in group hierarchy with clickable navigation elements
